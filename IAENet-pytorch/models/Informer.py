...
from layers.SelfAttention_Family import ProbAttention, AttentionLayer, TimeAwareFiLM, FiLM
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        if configs.FiLM:
            ...
            # Embedding
            self.enc_embedding = DataEmbedding(self.dynamic_numbers, configs.d_model, configs.embed, configs.freq,
                                               configs.dropout)
        else:
            # Embedding
    ...
    def classification(self, x_enc, x_mark_enc):
        ...
        enc_out = self.enc_embedding(x_enc, None) #modulated_dynamic
        enc_out, attns = self.encoder(enc_out, attn_mask=None)
